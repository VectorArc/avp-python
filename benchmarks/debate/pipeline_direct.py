"""Direct single-agent baseline for Debate benchmark."""
...
from .agents import DIRECT_SOLVE_PROMPT, SYSTEM_MESSAGE, extract_yes_no
...
def run_direct_pipeline(
    ...
    """Solve a single StrategyQA question with one agent (no debate)."""
    ...
    prediction = extract_yes_no(text)
...
def run_direct_benchmark(
    ...
    """Run direct single-agent pipeline on StrategyQA samples."""
    results = []
