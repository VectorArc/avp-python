"""Direct single-agent baseline for Compiler benchmark."""
...
def run_direct_pipeline(
    ...
    """Solve a single MATH-500 problem with one agent (no chain)."""
...
def run_direct_benchmark(
    ...
    """Run direct single-agent pipeline on MATH-500 samples."""
    results = []
